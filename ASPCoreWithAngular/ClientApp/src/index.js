...
/*Downloaded from https://www.codeseek.co/arvindr21/a-pen-by-arvind-ravulavaru-xbELZQ */
...
ngJSTree.directive('jsTree', function($http) {
  ...
  return treeDir;
   ...
   angular.module('myapp', ['jsTree.directive'])
.controller('homeCtrl',['$scope', function($scope){
    $scope.treeModel = [ document.body.innerHTML = <div *ngFor="let emp of empList">{{ emp.id}}{{ emp.parent}}{{ emp.text }}</div>];           
}])